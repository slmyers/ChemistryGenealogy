...
describe('Search', function() {
    ...
    /** TEST TESTING 9:35pm FUNCTION ALL ABOVE: YES**/
    ...
    /**
     * TEST TESTING 10:03 PM
     */


    /**
     * TEST GIGA TEST GIGA 10:22pm
     */
    ...
    /**
     * GIGA TEST 10:38 TEST GIGA TESTING
     */
    ...
    it('Test that the submitted data IS in the admin panel!!!!', function() {
        ...
        //expect(element.all(by.id('adminPanelPersonPositionAndName').get(2)).getText()).toEqual("testcurrentposition testfirstname testlastname");
    ...
    it('Should be able to open postdocs section', function(){

        element.all(by.id('showPostDocInfoExpandButton')).first().click();

    });

    it('Should be able to open Degree Information section', function(){

        element.all(by.id('showDegreeInfoExpandButton')).first().click();

    });


    it('Should be able to open Postdocs this Person SUPERVISED section', function(){

        element.all(by.id('showSuperDocInfoExpandButton')).first().click();

    });

    it('Should be able to open People who this person supervised their DEGREES section', function(){

        element.all(by.id('showSuperDegInfoExpandButton')).first().click();
